...
<div class="mb-6">
    <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
        ...
        <span class="text-gray-800">Pendaftaran Baptis</span>
    </div>
    <h2 class="text-2xl font-bold text-gray-800">
        <i class="fas fa-water text-blue-600 mr-2"></i>Pendaftaran Baptis
    </h2>
</div>

<div class="bg-white rounded-lg shadow-md">
    <form action="<?= base_url('admin/pendaftaran/baptis/create') ?>" method="POST" enctype="multipart/form-data" class="p-6">
        <?= csrf_field() ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="full_name" name="full_name" 
                           ...
                           placeholder="Nama lengkap calon baptis">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label for="preferred_date" class="block text-sm font-medium text-gray-700 mb-2">
                        Tanggal Baptis yang Diinginkan
                    </label>
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-2">
                        ...
                        Dokumen: Akta Kelahiran, KK, atau dokumen pendukung lainnya
                    </p>
                </div>
        ...
        <div class="flex gap-3 pt-6 border-t mt-6">
            ...
            <a href="<?= base_url('admin/pendaftaran?type=baptis') ?>" 
