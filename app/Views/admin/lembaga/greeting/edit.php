...
<div class="mb-6">
    <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
        ...
        <span class="text-gray-800">Edit Sambutan</span>
    </div>
    <h2 class="text-2xl font-bold text-gray-800">Edit Sambutan</h2>
</div>

<div class="bg-white rounded-lg shadow-md">
    <form action="<?= base_url('admin/lembaga/greeting/edit/' . $greeting['id']) ?>" method="POST" enctype="multipart/form-data" class="p-6">
        <?= csrf_field() ?>
        ...
        <div class="mb-6">
            ...
            <textarea id="content" name="content" rows="12"
                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="Tulis isi sambutan di sini..."><?= old('content', $greeting['content']) ?></textarea>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" id="author_name" name="author_name" 
                           value="<?= old('author_name', $greeting['author_name']) ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                ...
                <div>
                    ...
                    <input type="text" id="author_position" name="author_position" 
                           value="<?= old('author_position', $greeting['author_position']) ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <?php if ($greeting['author_photo']): ?>
                        <div class="mb-4 text-center">
                            <img src="<?= base_url('uploads/greeting/' . $greeting['author_photo']) ?>" 
                                 alt="<?= $greeting['author_name'] ?>"
