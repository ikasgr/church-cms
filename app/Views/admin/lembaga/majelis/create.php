...
<div class="mb-6">
    <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
        ...
        <span class="text-gray-800">Tambah Majelis</span>
    </div>
    <h2 class="text-2xl font-bold text-gray-800">Tambah Majelis</h2>
</div>

<div class="bg-white rounded-lg shadow-md">
    <form action="<?= base_url('admin/lembaga/majelis/create') ?>" method="POST" enctype="multipart/form-data" class="p-6">
        <?= csrf_field() ?>
