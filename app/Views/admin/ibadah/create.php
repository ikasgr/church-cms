...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-800">Tambah Jadwal Ibadah</h2>
</div>

<div class="bg-white rounded-lg shadow-md">
    <form action="<?= base_url('admin/ibadah/create') ?>" method="POST" class="p-6">
        <?= csrf_field() ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="4"
                              class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              placeholder="Deskripsi singkat tentang ibadah ini"><?= old('description') ?></textarea>
                </div>
