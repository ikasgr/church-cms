...
<div class="mb-6">
    ...
    <h2 class="text-2xl font-bold text-gray-800">
        <i class="fas fa-plus-circle text-blue-600 mr-2"></i>Tambah Kategori Produk
    </h2>
</div>

<div class="bg-white rounded-lg shadow-md max-w-2xl">
    <form action="<?= base_url('admin/umkm/categories/create') ?>" method="POST" class="p-6">
        <?= csrf_field() ?>
        ...
        <div class="space-y-6">
            ...
            <div>
                ...
                <div class="mt-2 p-3 bg-gray-50 rounded-lg">
                    ...
                    <i id="iconPreview" class="<?= old('icon', 'fas fa-box') ?> text-3xl text-blue-600"></i>
                </div>
            </div>
