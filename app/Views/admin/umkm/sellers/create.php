...
<div class="mb-6">
    <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
        ...
        <span class="text-gray-800">Tambah Pelapak</span>
    </div>
    <h2 class="text-2xl font-bold text-gray-800">
        <i class="fas fa-store text-blue-600 mr-2"></i>Tambah Pelapak UMKM
    </h2>
</div>

<div class="bg-white rounded-lg shadow-md">
    <form action="<?= base_url('admin/umkm/sellers/create') ?>" method="POST" enctype="multipart/form-data" class="p-6">
        <?= csrf_field() ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" id="commission_rate" name="commission_rate" 
                           ...
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                    <p class="text-xs text-gray-500 mt-1">Persentase komisi yang akan diterima gereja dari setiap penjualan</p>
                </div>
        ...
        <div class="flex gap-3 pt-6 border-t mt-6">
            <button type="submit" 
                ...
                <i class="fas fa-save mr-2"></i>Simpan Pelapak
            </button>
