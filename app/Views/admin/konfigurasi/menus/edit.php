...
<div class="mb-6">
    <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
        ...
        <span class="text-gray-800">Edit Menu</span>
    </div>
    <h2 class="text-2xl font-bold text-gray-800">Edit Menu</h2>
</div>

<div class="bg-white rounded-lg shadow-md">
    <form action="<?= base_url('admin/konfigurasi/menus/edit/' . $menu['id']) ?>" method="POST" class="p-6">
        <?= csrf_field() ?>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="number" id="order_position" name="order_position" 
                           value="<?= old('order_position', $menu['order_position']) ?>"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                           placeholder="0">
