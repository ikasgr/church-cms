...
<div class="mb-6">
    <div class="flex items-center gap-2 text-sm text-gray-600 mb-4">
        ...
        <span class="text-gray-800">Edit Galeri</span>
    </div>
    <h2 class="text-2xl font-bold text-gray-800">Edit Galeri</h2>
</div>

<div class="bg-white rounded-lg shadow-md">
    <form action="<?= base_url('admin/galeri/edit/' . $gallery['id']) ?>" method="POST" enctype="multipart/form-data" class="p-6">
        <?= csrf_field() ?>
        ...
        <div id="videoFields" class="mb-6 hidden">
            ...
            <!-- Video Thumbnail -->
            <div class="mt-4">
                <?php if ($gallery['type'] == 'video' && $gallery['thumbnail']): ?>
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-2">Thumbnail Saat Ini</label>
                        <img src="<?= base_url('uploads/gallery/thumbnails/' . $gallery['thumbnail']) ?>" 
                             alt="Thumbnail"
                             class="max-w-xs rounded-lg shadow-md">
                    </div>
                <?php endif; ?>
